package com.mygate.licious.threading;
...
public class BusinessExecutor implements IBusinessExecutor {
    ...
    @Override
    public void submitInSessionResourceThread(Runnable command) throws NullPointerException {
        mSessionResourcePoolExecutor.execute(command);
    }

    @Override
    public Executor getResourceExecutor() {
        return mResourcePoolExecutor;
    }

    @Override
    public Executor getBusinessExecutor() {
        return mBusinessPoolExecutor;
    }
}
